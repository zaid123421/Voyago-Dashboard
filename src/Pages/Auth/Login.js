    ...
    <div className="auth-card position-absolute">
      <div className="first-child">
        ...
        <div className="input-box d-flex flex-d-c mb-15">
          <label className="mb-15" htmlFor="login-email-input">
            Email
          </label>
          <input
            autoFocus
          ...
          {accept && (error === 500 || error === 401) && (
            <p className="error-bottom fs-14 position-absolute color-red">
              Invalid Email or Password
            </p>
          )}
        </div>
        <div className="input-box d-flex flex-d-c">
          <label className="mb-15" htmlFor="login-password-input">
            Password
          </label>
          <input
            className="main-input"
        ...
        <div>
          <NavLink className="mt-15 fs-14" to="/forgotpassword">
            Forgot Password ?
          </NavLink>
        </div>
        <button onClick={Submit} className="special-button">
          Sign in
        </button>
        <button onClick={withoutLogin} className="special-button">
          Couninue as Guest
        </button>
      </div>
      <div className="second-child">
        <div className="login-text">
          ...
          <p className="fs-18 fw-500 mt-15">
